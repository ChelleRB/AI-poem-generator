...
function generatePoem(event) {
  ...
  let context =
    "You are a romantic AI writer. You write 4 line answers in HTML format eg. <p> Your answer</p>. Sign the end of the poem within <strong>'Yours Sincerely'</strong> Not the beginning";
  let prompt =
